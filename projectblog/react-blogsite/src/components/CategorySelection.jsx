...
const CategorySelection = ({ onSelectCategory, activeCategory }) => {
  const categories = ["Startups", "Security", "AI", "Apps", "Tech","Fintech","Health","Enterprise","Growth","Work","Gadgets"];
  return (
    <div className="px-4 md-8 lg:space-x-14 flex-wrap items-center border-b-2 py-5 text-gray-900 font-semibold">
