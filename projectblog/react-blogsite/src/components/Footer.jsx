    ...
    <div className="bg-gray-900">
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
        <div className="grid mb-8 lg:grid-cols-6">
          ...
          {/* {Subscription} */}
          <div className="max-w-md lg:col-span-2 lg:mt-0 mt-5">
            <p className="font-medium tracking-wide text-gray-300">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              Accusantium temporibus accusamus ratione quod officiis sit veniam
              quae vel quidem enim repellendus, ullam eos. Vitae repellat
              eveniet modi culpa fugit numquam!
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href=""
              className="text-gray-500 transition-all duration-300 hover:text-blue-400"
            >
